...
help:
	...
	@echo ""
	@echo "Run Commands:"
	@echo "  run             Run the application (requires DATABASE_URL and WHATSAPP_CLIENTS)"
...
## run: Run the application (requires DATABASE_URL and WHATSAPP_CLIENTS)
run: build
...
run-debug: build
	...
	@echo "Starting WhatsApp Web API with DEBUG logging..."
