...
aws --endpoint-url https://your-s3-endpoint.com \
    --region us-east-1 \
    s3 ls s3://id1/
```

**Fix:**
1. Log into your MinIO console at https://your-s3-endpoint.com
...
**Incorrect:**
```env
S3_ENDPOINT=https://your-s3-endpoint.com/id1
S3_ENDPOINT=https://id1.your-s3-endpoint.com
```
...
curl -v https://your-s3-endpoint.com 2>&1 | grep -i "server:"

# Check system time
date && curl -sI https://your-s3-endpoint.com | grep -i date
